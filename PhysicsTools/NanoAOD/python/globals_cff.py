...
genFilterTable = cms.EDProducer("SimpleGenFilterFlatTableProducerLumi",
        ...
        extension = cms.bool(False),
    variables = cms.PSet(
        numEventsTotal        = Var("numEventsTotal()",        float, doc="generator filter: total number of events",  precision=14),
        numEventsPassed       = Var("numEventsPassed()",       float, doc="generator filter: passed number of events", precision=14),
