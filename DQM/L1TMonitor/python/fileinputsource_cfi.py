...
#
sampleIdentifier = '265377_DAS' #266277_DAS 265377_DAS 263675 251251_DAS 265377_DAS 263675 251251_relVal_runTheMatrix_step3 251251 relVal_step3 relVal_CMSSW_8_0_0_pre6 251251 251131 165633-CAFDQM 195378
...
if sampleIdentifier == '266277_DAS': #2016 MWGR3
    runNumber = '266277'
...
elif sampleIdentifier == '265377_1': #2016 MWGR2
    runNumber = '265377'
    dataset = '/Cosmics/Commissioning2016-v1/RAW'
    dataType = 'RAW'
    useDAS = False
...
elif sampleIdentifier == '265377_2': #2016 MWGR2
    runNumber = '265377'
    dataset = '/Cosmics/Commissioning2016-v1/RAW'
    dataType = 'RAW'
    useDAS = False
    readFiles.extend(['file:/afs/cern.ch/work/m/mzarucki/data/Cosmics_Commissioning2016-v1_RAW_2.root'])
